...
use gos_runtime::{ExistentialDeposit, RuntimeApi};
...
impl SubstrateCli for Cli {
	...
	fn support_url() -> String {
		"https://github.com/gridoperatingsystems/gosb-sdk/issues/new".into()
	}
	...
	fn load_spec(&self, id: &str) -> std::result::Result<Box<dyn sc_service::ChainSpec>, String> {
		let spec = match id {
			...
			"spectral" => Box::new(chain_spec::spectral_config()?),
