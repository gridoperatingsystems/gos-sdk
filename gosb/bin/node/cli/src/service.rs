...
pub fn create_extrinsic(
	...
	function: impl Into<gos_runtime::RuntimeCall>,
	nonce: Option<u32>,
) -> gos_runtime::UncheckedExtrinsic {
	...
	let period = gos_runtime::BlockHashCount::get()
	...
	let extra: gos_runtime::SignedExtra = (
		...
		frame_system::CheckTxVersion::<gos_runtime::Runtime>::new(),
		frame_system::CheckGenesis::<gos_runtime::Runtime>::new(),
		frame_system::CheckEra::<gos_runtime::Runtime>::from(generic::Era::mortal(
			period,
	...
	let raw_payload = gos_runtime::SignedPayload::from_raw(
		...
		(
			(),
			gos_runtime::VERSION.spec_version,
	...
	gos_runtime::UncheckedExtrinsic::new_signed(
		function,
		sp_runtime::AccountId32::from(sender.public()).into(),
		gos_runtime::Signature::Sr25519(signature),
		extra,
	)
}
