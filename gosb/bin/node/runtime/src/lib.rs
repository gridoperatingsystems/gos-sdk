...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("gosb"),
	impl_name: create_runtime_str!("gosb"),
...
parameter_types! {
	pub const ExistentialDeposit: Balance = 1000000000000;
...
parameter_types! {
	...
	pub const Burn: Permill = Permill::from_percent(3);
